...
@Composable
fun DropDownMenuSelector(itemList:List<Pair>,selectedItem:String,onItemSelected:(String)->Unit){
...
data class Pair(val id:String,val region:String)

fun RegionalList():List<Pair>{
    val regionalList = listOf<Pair>(
